...
interface UnitDef {
  name: any; // 'convert' package unit type
  label: string;
  decimals: number;
}
interface OutUnitDef extends UnitDef {
  convert?: (v: number) => any;
}
...
const unitMapping = new Map<string, UnitMapping>([
  [
    "wmoUnit:degC",
    {
...
const round = (value: any, { decimals }: { decimals: number }) => {
...
export const convertValue = (obj: any) => {
...
export const convertProperties = (obj: any) => {
  let unitKey = "unitCode";
