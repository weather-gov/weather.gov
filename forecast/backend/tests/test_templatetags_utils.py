...
class TestTemplateTagUtilities(TestCase):
    ...
    def test_datetime_with_no_timezone(self):
        ...
        self.assertEqual(util.datetime(str), expected)
    ...
    def test_datetime_with_timezone(self):
        ...
        self.assertEqual(util.datetime(str, "America/New_York"), expected)
    ...
    def test_time_range_same_day(self):
        ...
        self.assertEqual(util.time_range(start, end), expected)
    ...
    def test_json_encode_with_bad_type(self):
        ...
        self.assertEqual(util.json_encode("They're coming to get you, Barbara"), "")
    ...
    def test_json_encode(self):
        ...
        o = {"key": "value"}
        self.assertEqual(util.json_encode(o), json.dumps(o))
    ...
    def test_normalize_alert_whitespace(self):
        ...
        self.assertEqual(actual, "This is<br />some text<br />in an<br />alert")
