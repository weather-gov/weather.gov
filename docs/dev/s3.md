...
The easiest way to look at the contents of a S3 bucket is to mount it locally. We can use [s3fs-fuse](https://github.com/s3fs-fuse/s3fs-fuse) for this purpose.
