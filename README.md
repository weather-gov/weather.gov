...
The **API Interop Layer** is available at [http://localhost:8082](http://localhost:8082). You can test the APIs using the OpenAPI interface at [http://localhost:8082/documentation](http://localhost:8082/documentation).
